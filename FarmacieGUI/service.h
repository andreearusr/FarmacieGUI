...
public:
	...
	*/
	Service(Repo& all, Validator& valid, Reteta& reteta) noexcept : all{ all }, valid{ valid }, reteta{ reteta } {};
	...
	*/
	void add_medicament(const string& den, const string& prod, const string& subst, float pret);

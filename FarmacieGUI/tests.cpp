...
void test_service() {
	...
	Reteta reteta{ r };
	Service srv{ r, valid , reteta};
	srv.add_medicament("VitaminaC", "Bayer", "acid ascorbic", 22);
	srv.undo();
	...
	srv.add_medicament("VitaminaC", "Bayer", "acid ascorbic", 22);
	srv.add_medicament("Aspirina", "Carl", "acid acetilsalicilic", 15);
	assert(srv.get_all().size() == 2);
	

	srv.adauga_reteta("VitaminaC");
	Medicament medicament = reteta.cauta("VitaminaC");
	assert(medicament.get_pret() == 22);
	...
	vector<Medicament> rezz = srv.all_meds();

	DTO dto;
	assert(dto.get_count() == 0);
	srv.add_medicament("aaa", "Carl", "acid", 15);
...
void test_filtrare()
{
	...
	Reteta reteta{ r };
	Service srv{ r, valid , reteta };
	srv.add_medicament("VitaminaC", "Bayer", "acid", 22);
	srv.add_medicament("Aspirina", "Carl", "vitamina", 22);
	srv.add_medicament("Ampicilina", "Laropharm", "acid", 17);
	srv.add_medicament("Voltaren", "Carl", "diclofenac", 70);
	srv.add_medicament("Parasinus", "Laropharm", "ibuprofen", 30);
...
void test_sortare() {
	...
	srv.add_medicament("Ampicilina", "Laropharm", "acid", 17);
	srv.add_medicament("Voltaren", "Carl", "diclofenac", 70);
	srv.add_medicament("Parasinus", "Laropharm", "acid", 12);
